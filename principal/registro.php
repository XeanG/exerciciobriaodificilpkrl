  ...
  <div class="container position-absolute top-50 start-50 translate-middle w-50">
    ...
    <form method="POST" action="php.php">
      <div class="row mb-3 d-flex justify-content-evenly align-items-center">
        <label for="nome_completo" class="col-sm-2 col-form-label w-25">Nome completo:</label>
        <div class="col-sm-10 w-75">
          <input type="text" class="form-control" id="nome_completo" name="nome_completo">
        </div>
      </div>
      <div class="row mb-3 d-flex justify-content-evenly align-items-center">
        <label for="email" class="col-sm-2 col-form-label w-25">Endereço de e-mail:</label>
        <div class="col-sm-10 w-75">
          <input type="text" class="form-control" id="email" name="email">
        </div>
      </div>
      <div class="row mb-3 d-flex justify-content-evenly align-items-center">
        <label for="nome_de_usuario" class="col-sm-2 col-form-label w-25">Nome de usuário:</label>
        <div class="col-sm-10 w-75">
          <input type="text" class="form-control" id="nome_de_usuario" name="nome_de_usuario">
        </div>
      </div>
      <div class="row mb-3 d-flex justify-content-evenly align-items-center">
        <label for="senha" class="col-sm-2 col-form-label w-25">Senha:</label>
        <div class="col-sm-10 w-75">
