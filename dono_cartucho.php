...
<body>
  ...
  <div class="container position-absolute top-50 start-50 translate-middle w-50 h-75 d-flex align-items-evenly justify-items-center row">
    <h1 class="text-center">Dono do cartucho
      <?php
      echo $_POST["nome_cartucho_cd"];
      ?>
    </h1>
    <?php
    ...
    $sql = "SELECT c.id, c.nome_cartucho_cd, c.ano, c.sistema, c.tela, u.nome_completo FROM cartuchos c INNER JOIN usuarios u ON c.id_usuario = u.id WHERE c.nome_cartucho_cd = '$cartucho'";
